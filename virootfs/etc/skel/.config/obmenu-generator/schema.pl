...
our $SCHEMA = [
    ...
    {item => ["$terminal -geometry 110x35 -e 'less /usr/share/hunux/welcome_message'",  'Welcome', 'welcome']},
    {item => ["sudo $terminal -e hunux-installer",  'Install Hunux', 'install']},
    ...
    {beg => ['Power', 'power'] },
        ...
        {item => ["sudo hunuxizer reboot", 'Reboot', 'reboot']},
        {item => ["sudo hunuxizer poweroff", 'Shutdown', 'poweroff']},
	{end => undef},
